...
class Rouge(Rouge155):
    ...
    # Follow the following link to fix the bug:
    ...
    def __init__(self, n_words=None,
        ...
        # You need to install rouge by yourself
        super(Rouge, self).__init__(
            rouge_home='/PATH_TO_YOUR_INSTALLED_ROUGE/rouge/tools/ROUGE-1.5.5/',
            n_words=n_words, stem=stem,
            keep_files=keep_files)
        # modified to current setting
        # self._rouge_data = './rouge/pyrouge/tools/ROUGE-1.5.5/data'
